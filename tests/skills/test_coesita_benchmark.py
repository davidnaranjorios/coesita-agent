...
from skills.coesita.ftm_engine import DOMAINS, generate_scenarios
...
def test_scan_extra_entry_merges_and_overrides_seed():
    extra = [
        {"slug": "langgraph", "notes": "actualizado desde la web",
    ...
    assert by_slug["langgraph"]["notes"] == "actualizado desde la web"
...
def test_scan_artifacts_detects_features_from_content():
    ...
    from skills.coesita.feature_scenarios import packs_for_features
...
def test_scan_artifacts_empty_content_detects_nothing():
    from skills.coesita.framework_scanner import scan_artifacts
